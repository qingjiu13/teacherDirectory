...
const _sfc_main = common_vendor.defineComponent({
  ...
  computed: {
    // 从Vuex中获取状态
    testResult() {
      return store_index.store.getters["user/aiChat/testResult"];
    },
    isTesting() {
      return store_index.store.getters["user/aiChat/isTesting"];
    },
    isLoading() {
      return store_index.store.getters["user/aiChat/isLoading"];
    },
    // 历史会话摘要
    historySummaries() {
      return store_index.store.getters["user/aiChat/historySummaries"] || [];
    },
    // 历史会话
    historyChats() {
      return store_index.store.getters["user/aiChat/historyChats"] || [];
    },
    // 当前选择的学校名称
    currentSchool() {
  ...
  methods: {
    ...
    loadUniversityData() {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/AI/AI.vue:264", "成功加载", this.schoolList.length, "所大学数据");
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:266", "加载大学数据失败:", error);
    ...
    getUserInfo() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:307", "获取用户信息失败:", e);
      }
    },
    /**
    ...
    saveUserInfo() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:339", "保存用户信息失败:", e);
    ...
    onSchoolSearch(keyword = null) {
      common_vendor.index.__f__("log", "at pages/AI/AI.vue:373", "正在搜索学校:", keyword);
    },
    /**
     * @description 切换对话模式
    ...
    startNewChat() {
      ...
      store_index.store.dispatch("user/aiChat/setCurrentChat", this.currentChatId);
    ...
    handleMessage(messageContent = null, retryIndex = null) {
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          const response = yield store_index.store.dispatch("user/aiChat/testAIQA", new UTSJSONObject({
          ...
          if (response.success) {
            ...
            common_vendor.index.__f__("error", "at pages/AI/AI.vue:488", "AI回复失败:", errorMessage, response.error);
          ...
          common_vendor.index.__f__("error", "at pages/AI/AI.vue:508", "消息处理异常:", errorMsg, error);
    ...
    loadChatHistory(chatId = null) {
      ...
      try {
        ...
        store_index.store.dispatch("user/aiChat/loadChat", chatId).then((response = null) => {
          var _a, _b;
          if (response.success) {
            ...
            common_vendor.index.__f__("error", "at pages/AI/AI.vue:652", "加载对话失败:", errorMsg, response.error);
          ...
          common_vendor.index.__f__("error", "at pages/AI/AI.vue:663", "加载对话异常:", error);
        ...
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:670", "加载对话内容失败:", error);
    ...
    loadChatHistoryFromStorage() {
      store_index.store.dispatch("user/aiChat/getHistoryChats").then((response = null) => {
        if (!response.success) {
          common_vendor.index.__f__("error", "at pages/AI/AI.vue:684", "加载历史会话摘要失败:", response.error || response.message);
          this.showToast("加载历史对话记录失败，将使用本地缓存", "none", 2e3);
        }
      }).catch((error = null) => {
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:688", "加载历史会话异常:", error);
      });
    },
    /**
    ...
    saveChatHistory() {
      ...
      store_index.store.dispatch("user/aiChat/saveChat", chatData);
    },
    /**
     * @description 删除历史记录
    ...
    deleteChatHistory(chatId = null) {
      if (!chatId) {
        common_vendor.index.__f__("error", "at pages/AI/AI.vue:722", "删除历史记录失败: 无效的chatId");
      ...
      common_vendor.index.showModal(new UTSJSONObject({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            store_index.store.dispatch("user/aiChat/deleteChat", chatId).then((response = null) => {
              var _a;
              ...
              if (response.success) {
                ...
                common_vendor.index.__f__("error", "at pages/AI/AI.vue:753", "删除失败:", response.message || "未知错误", response.error);
              ...
              common_vendor.index.hideLoading();
              common_vendor.index.__f__("error", "at pages/AI/AI.vue:775", "删除过程发生异常:", error);
