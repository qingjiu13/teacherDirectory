<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="analysis_result" label="">
        <undefined v-model="formData.analysis_result"></undefined>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,university,major,rank,status,plan,studyMode,targetMajor,targetTypes,targetAreas,create_time,analysis_status,analysis_result").get().then((res) => {
