...
const _sfc_main = common_vendor.defineComponent(new UTSJSONObject({
  ...
  methods: new UTSJSONObject({
      ...
      if (this.isLoggedIn) {
        ...
        if (userInfo) {
          try {
            ...
            common_vendor.index.__f__("error", "at pages/mine/order/order_common.uvue:368", "解析用户信息失败:", e);
          }
        }
      } else {
     ...
     */
    loadOrderData() {
      common_vendor.index.__f__("log", "at pages/mine/order/order_common.uvue:385", `加载${this.userRole}角色的订单数据`);
    },
    /**
     * @description 切换标签页
